...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[20rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
      <div className="bg-gray-100 h-full w-full rounded-2xl grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 overflow-hidden p-4">
        {users.map((user, idx: number) => (
          ...
          >
            ...
            <Image
              src="https://i.pinimg.com/564x/dc/a7/0b/dca70ba7017cb81ef61103f9ba5f1d0b.jpg"
            ...
            />
            <div className="p-4">
              <h1 className="font-semibold text-sm text-zinc-700">{user.name}</h1>
